...
*/function loadJS(e, t) { 
    for (i = 0; i < e.length; i++) { 
        ...
        r.type = "text/javascript"; r.async = !1; 
        r.src = e[i]; n.appendChild(r) 
    } 
    if (t) { var n = document.getElementsByTagName("body")[0], r = document.createElement("script"); r.type = "text/javascript"; r.async = !1; r.src = t; n.appendChild(r) } 
}; 
function loadCSS(e, t) { 
    if (!cssArray[e]) { cssArray[e] = !0; var n = document.getElementsByTagName("head")[0], r = document.createElement("link"); 
...
function setUpUrl(e) { 
    ...
    $('.nav li:has(a[href="' + e + '"])').addClass("active").parent().show(); loadPage(e) 
}; 
function loadPage(e) { 
    var t = $(".main"); 
    $.ajax({ 
    ...
    function activeCharts() { 
        if ($(".boxchart").length) 
            ...
            if (jQuery.browser.mozilla) 
                ...
                negBarColor: "#eeeeee" }); 
        if ($(".linechart").length) 
            if (retina()) { $(".linechart").sparkline("html", { 
                width: "130", 
                height: "60", 
                lineColor: "#ffffff", 
                fillColor: !1, 
            ...
            $(document).ready(function (e) { 
                ...
                //         var tmp = $(this).find('a').find('span').eq(1).hasClass("fa-angle-down");
                //         console.log("tmp:",tmp);
                //         $(this).find('a').find('span').eq(1).hasClass("fa-angle-down") ? $(this).find('a').find('span').eq(1).removeClass("fa-angle-down").addClass("fa-angle-up") : $(this).find('a').find('span').eq(1).removeClass("fa-angle-up").addClass("fa-angle-down"); 
                //     });
                //     // $(this).find('ul').children('li').each(function(a){
                //     //     $(this).click(function(){
    ...
    $(document).ready(function (e) { 
        ...
        e(".btn-minimize").click(function (t) { t.preventDefault(); var n = e(this).parent().parent().next(".panel-body"); n.is(":visible") ? e("i", e(this)).removeClass("fa-chevron-up").addClass("fa-chevron-down") : e("i", e(this)).removeClass("fa-chevron-down").addClass("fa-chevron-up"); n.slideToggle("slow", function () { widthFunctions() }) }); 
        e(".btn-setting").click(function (t) { t.preventDefault(); e("#myModal").modal("show") }) }); $(".sidebar-menu").scroll(function () { dropSidebarShadow() }); 
