$(document).ready(function () {
    ...
    $('#search-button').click(function () {
        ...
        $.get('./api/data_streams?search_id=' + $('#search-did-input').val() + '&search_sname=' + $('#search-sname-input').val() + '&search_mode=' + search_mode + '&page_num=1&page_size=1000&sort_by=at&sort=desc', function (result, status) {
            if (result.result == 0) {
